...
def main():
    ...
    def clamped_boundary(x, on_boundary):
        return on_boundary and (x[0] < fe.DOLFIN_EPS or x[0] > CANTILEVER_LENGTH - fe.DOLFIN_EPS)
    ...
    forcing = fe.Constant((0.0, 0.0, - DENSITY * ACCELERATION_DUE_TO_GRAVITY-0.05))
    ...
    beam_deflection_file = fe.XDMFFile("beam_deflections8.xdmf")
